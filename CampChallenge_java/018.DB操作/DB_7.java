...
public class DB_7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //prepareStatementでprofilesID1のデータのうち、name,age,birthdayを更新するSQL文を用意
            
            db_st.setString(1, "松岡 修造");    //1番目の?に『松岡 修造』を設定
            db_st.setInt(2, 48);        //2番目の?に『48』を設定
            db_st.setString(3, "1967-11-06");   //3番目の?に『1967-11-06』を設定
            
            db_st.executeUpdate();  //executeUpdateメソッドでUPDATEを実行
            
            db_st = db_con.prepareStatement("select*from profiles");    //全件表示
