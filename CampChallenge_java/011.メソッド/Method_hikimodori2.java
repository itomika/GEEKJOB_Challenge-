 ...
 * @author itou
 */
public class Method_hikimodori2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for(int i=0;i<3;i++){  //全員分のプロフィールを出力　[hitobito]の中身をループしている
            
            String[] dareka = prof(i);  //[dareka]の中に[[hitobito]の中身をループしている]ものを格納
